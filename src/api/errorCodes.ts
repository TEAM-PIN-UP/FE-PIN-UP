...
// Member Error Codes
export type MemberErrorCodeType = "M001" | "M002" | "M003" | "M004" | "M005";
...
// Alarm Error Codes
export type AlarmErrorCodeType = "AL001" | "AL002" | "AL003";
...
export const ErrorCodes = {
  ...
  Auth: {
    ...
    EXPIRED_ACCESS_TOKEN2: "E_AUTH006",
  },
...
const errorMessages: Record<ErrorCodeType, string> = {
  ...
  E_AUTH006: "Access Token이 만료되었습니다. 토큰을 재발급해주세요.",
